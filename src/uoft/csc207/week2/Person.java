package uoft.csc207.week2; // collection of related classes
...
class Person {
     ...
     */
    String[] name; // specifically declare type and name, like __init__
    /**
     * The person's UTORid
     */
    String utorid;
    ...
    String formatName() {
        ...
        while (i != this.name.length - 1) {
            ...
            i += 1;
        } // Java doesn't care about spaces and indents!
        // don't need to worry about style errors as much
